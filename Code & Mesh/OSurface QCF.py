...
runNames = ["leaves", "Wigly_Cylinder"]
...
def stepInTime(stepNum, runIndx, paramIndex, a, b, c, d, e, a3, regC):
    ...
    res = solver.run(displacements, startingVerts=vertices0, initDisps=displacements, 
                      faces=faces, areaMat=areaMat,normals=normals, vertexAreas=vertexAreas, boundaryLengths=boundaryLengths,
...
#===========================================================================================================
@jit
def cost(disps, startingVerts, initDisps, faces, areaMat, normals, vertexAreas, boundaryLengths,
             initBoundaryDisps,  boundaryInds, boundaryNormals, gradCostMat, prevStrains, 
                   initialArea, duration, a, b, c, d, e, a3, regC) :
    '''
    '''
    
    strains, bendingStrain = getDeformations(startingVerts, disps, faces)
...
# #===========================================================================================================
# @jit
# def cost_per_simplex(init_positions, displacements):
...
#     return getDilationAndShear(strain)#dilation, shear, traceless
